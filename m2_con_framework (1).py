...
Original file is located at
    https://colab.research.google.com/github/1dgog/tc3006c_m2_portafoliodeanalisis/blob/main/m2_con_framework.ipynb
...
plt.savefig('hm_train.png') 
files.download("hm_train.png")
plt.show()
